...
*Between pixels within FMLN controlled zones and disputed zones (not including pixels in expansion zones)
rdrobust nl13_density z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular) 
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("Night light") addtext("Note", "Main") addstat("Polynomial", 1) nonote replace 

rdrobust nl13_density_v2 z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("Night light") addtext("Note", "Trim p1-p99") addstat("Polynomial", 1) nonote append  

rdrobust nl13_density_v3 z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("Night light") addtext("Note", "Trim p5-p95") addstat("Polynomial", 1) nonote append 

rdrobust ln_nl13 z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("ln(Night light)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append 

rdrobust ln_nl13_plus z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("ln(Night light+0.01)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append  

rdrobust arcsine_nl13 z_run_cntrl if within_expansion==0 & (within_control==1 | within_disputed==1), all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_cvsd.tex", tex(frag) ctitle("arcsine(Night light)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append  
...
*Between pixels within and outside disputed FMLN zones (not including pixels in controlled and expansion zones)
rdrobust nl13_density z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("Night light") addtext("Note", "Main") addstat("Polynomial", 1) nonote replace  

rdrobust nl13_density_v2 z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("Night light") addtext("Note", "Trim p1-p99") addstat("Polynomial", 1) nonote append 

rdrobust nl13_density_v3 z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("Night light") addtext("Note", "Trim p5-p95") addstat("Polynomial", 1) nonote append 

rdrobust ln_nl13 z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("ln(Night light)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append 

rdrobust ln_nl13_plus z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("ln(Night light+0.01)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append  

rdrobust arcsine_nl13 z_run_dsptd if within_expansion==0 & within_control==0, all kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("arcsine(Night light)") addtext("Note", "Transformation") addstat("Polynomial", 1) nonote append  

rdrobust nl13_density z_run_dsptd if within_expansion==0 & within_control==0, all covs(elevation) kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("Night light") addtext("Note", "Elevation control") addstat("Polynomial", 1) nonote append  

rdrobust ln_nl13 z_run_dsptd if within_expansion==0 & within_control==0, all covs(elevation) kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("ln(Night light)") addtext("Note", "Elevation control") addstat("Polynomial", 1) nonote append  

rdrobust arcsine_nl13 z_run_dsptd if within_expansion==0 & within_control==0, all covs(elevation) kernel(triangular)
outreg2 using "${tables}\rdd_robustness_dvsnd.tex", tex(frag) ctitle("arcsine(Night light)") addtext("Note", "Elevation control") addstat("Polynomial", 1) nonote append
...
reghdfe nl13_density within_disputed z_run_dsptd i.within_disputed#c.z_run_dsptd x_coord y_coord [aw=weights] if within_expansion==0 & within_control==0 & abs(z_run_dsptd)<=${h}, vce(r) a(i.disputa_break_fe_400)
reghdfe nl13_density within_disputed z_run_dsptd i.within_disputed#c.z_run_dsptd x_coord y_coord [aw=weights] if within_expansion==0 & within_control==0 & abs(z_run_dsptd)<=${h}, vce(r) a(i.disputa_break_fe_200)
reghdfe nl13_density within_disputed z_run_dsptd i.within_disputed#c.z_run_dsptd x_coord y_coord [aw=weights] if within_expansion==0 & within_control==0 & abs(z_run_dsptd)<=${h}, vce(r) a(i.disputa_break_fe_100)
reghdfe nl13_density within_disputed z_run_dsptd i.within_disputed#c.z_run_dsptd x_coord y_coord [aw=weights] if within_expansion==0 & within_control==0 & abs(z_run_dsptd)<=${h}, vce(r) a(i.disputa_break_fe_50)
...
gr export "${plots}\rdplot_p1_z_run_dvsnd.pdf", as(pdf) replace 
...
gr export "${plots}\rdplot_p2_z_run_dvsnd.pdf", as(pdf) replace 
