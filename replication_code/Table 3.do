...
*Global of outcomes
gl educ "z_wi_always mean_educ_years_always zwi_trimmed educ_years_trimmed zwi_trimmed80 educ_years_trimmed80 zwi_trimmed85 educ_years_trimmed85 "
...
foreach var of global educ{
	...
	*Table
	...
	outreg2 using "${tables}/rdd_educ_trimm_all.tex", tex(frag) keep(within_control) nor2 addstat("Bandwidth (Km)", ${h}, "Dependent mean", ${mean_y}) label nonote nocons `r'
	local r append
}


preserve 
  insheet using "${tables}/rdd_educ_trimm_all.txt", nonames clear
 drop v2 

replace v1 = "Guerrilla control" in 4
replace v3 = "Wealth Index" in 2
replace v5 = "Wealth Index" in 2
replace v7 = "Wealth Index" in 2
replace v9 = "Wealth Index" in 2
replace v6 = "Years of Education" in 2
replace v8 = "Years of Education" in 2
replace v10 = "Years of Education" in 2
drop in 1
replace v1 = "" in 1
insobs 1, before(3)
replace v3 = "(1)" in 2
...
dataout, tex save("${tables}/rdd_educ_trimm_all") replace nohead midborder(2)
