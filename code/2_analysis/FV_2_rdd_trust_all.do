...
gl lap5 "aprobacion5 aprobacion5_median aprobacion5_p75"
...
cap erase "${tables}\rdd_trust_all_p5.tex"
cap erase "${tables}\rdd_trust_all_p5.txt"
...
foreach var of global lap5{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_trust_all_p5.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
foreach var of global lap1{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_trust_all_p1_diffbw.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
