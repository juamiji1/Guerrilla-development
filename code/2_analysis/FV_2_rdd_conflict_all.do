...
cap erase "${tables}\rdd_conflict_all_p1.tex"
cap erase "${tables}\rdd_conflict_all_p1.txt"

*RDD with break fe and triangular weights 
rdrobust arcsine_nl13 z_run_cntrl if sampler==1, all kernel(triangular)
gl h=e(h_l)
gl b=e(b_l)
gl h=2.266
...
foreach var of global nl{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_conflict_all_p1.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
*-------------------------------------------------------------------------------
*Erasing table before exporting new one
cap erase "${tables}\rdd_conflict_all_p2.tex"
cap erase "${tables}\rdd_conflict_all_p2.txt"

*RDD with break fe and triangular weights 
rdrobust arcsine_nl13 z_run_cntrl if sampled==1, all kernel(triangular)
gl h=e(h_l)
gl b=e(b_l)
gl h=1.016
...
foreach var of global nl{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_conflict_all_p2.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
*Erasing table before exporting new one
cap erase "${tables}\rdd_homicide_all.tex"
cap erase "${tables}\rdd_homicide_all.txt"
...
foreach var of global klls{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_homicide_all.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
*RDD with break fe and triangular weights 
rdrobust arcsine_nl13 z_run_cntrl if sample!=., all kernel(triangular)
gl h=e(h_l)
gl b=e(b_l)
...
cap erase "${tables}\rdd_conflict_all_noc82.tex"
cap erase "${tables}\rdd_conflict_all_noc82.txt"
...
foreach var of global nl{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_conflict_all_noc82.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
*Erasing table before exporting new one
cap erase "${tables}\rdd_conflict_all_centroid_p2.tex"
cap erase "${tables}\rdd_conflict_all_centroid_p2.txt"
...
foreach var of global nl1{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_conflict_all_centroid_p2.tex", tex(frag) keep(within_control) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
...
*Erasing table before exporting
cap erase "${tables}\rdd_conflict_all_disp.tex"
cap erase "${tables}\rdd_conflict_all_disp.txt"
...
foreach var of global nl1{
	...
	*Table
	...
	outreg2 using "${tables}\rdd_conflict_all_disp.tex", tex(frag) keep(within_control within_disputa) addtext("Kernel", "Triangular") addstat("Bandwidth (Km)", ${h},"Polynomial", 1, "Dependent mean", ${mean_y}) label nonote nocons append 
