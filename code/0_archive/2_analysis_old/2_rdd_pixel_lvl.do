...
foreach s of global segments{
	...
	outreg2 using "${tables}\rdd_dvsnd_`s'.tex", tex(frag) keep(within_disputed) ctitle("Night light") addtext("Controls", "dist", "N breaks FE", "0") addstat("Bandwidth", ${h}) nocons nonote replace 
	...
	*Combined specification
	...
	outreg2 using "${tables}\rdd_dvsnd_`s'.tex", tex(frag) keep(within_disputed) ctitle("Night light") addtext("Controls", "distXY", "N breaks FE", "`s'") addstat("Bandwidth", ${h}) nocons nonote append 
